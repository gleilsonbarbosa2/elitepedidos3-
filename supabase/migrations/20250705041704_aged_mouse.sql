/*
  # Update Operator Permissions Structure

  1. Changes
    - Add view permissions for each menu section
    - Update default permissions for all operators
    - Ensure admin operators have all permissions
