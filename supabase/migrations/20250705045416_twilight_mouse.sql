/*
  ...
  1. Changes
    ...
    - Fix close_pdv_cash_register function to resolve ambiguous column reference
    - Add detailed payment method tracking
    - Add debug information to help diagnose calculation issues

  2. Features
    - Accurate cash register summary including all sales channels
...
-- Create a function to get payment methods summary
