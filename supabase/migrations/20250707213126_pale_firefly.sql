/*
  # Fix Admin Permissions for Cash Register

  1. Changes
    - Update the admin user with all necessary permissions
    - Ensure the admin user has access to all cash register features
    - Add permissions for viewing cash register history
