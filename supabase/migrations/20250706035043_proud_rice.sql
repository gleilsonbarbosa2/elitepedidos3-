/*
  ...
  1. Changes
    ...
    - Fix field naming to ensure consistent data structure
    - Ensure proper calculation of "Outras Entradas" (other_income_total)
    - Add test data insertion for easier testing
