/*
  # Fix Cash Register Report to Include Delivery Sales

  1. Changes
    - Drop conflicting get_pdv_cash_summary functions
    - Create a single, correct version that properly includes delivery sales
    - Fix calculation of total_all_sales to include both PDV and delivery sales
...
DROP FUNCTION IF EXISTS get_pdv_cash_summary(uuid, boolean);
