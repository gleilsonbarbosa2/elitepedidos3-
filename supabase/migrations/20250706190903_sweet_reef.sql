/*
  # Fix Cash Register Calculation

  1. Changes
    - Fix the get_pdv_cash_summary function to properly subtract expenses
    - Ensure proper calculation of expected balance
    - Fix parameter handling to avoid function overloading issues
...
DROP FUNCTION IF EXISTS public.get_pdv_cash_summary(uuid, boolean);
...
BEGIN
    ...
    -- Calculate expected balance - FIXED: Properly subtract expenses
