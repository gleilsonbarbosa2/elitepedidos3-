/*
  ...
  1. Changes
    - Fix ambiguous column reference in close_pdv_cash_register function
    - Use explicit parameter names to avoid conflicts with column names
    - Ensure proper closing of cash registers
...
BEGIN
  ...
  WHERE pdv_cash_registers.id = close_pdv_cash_register.register_id;
