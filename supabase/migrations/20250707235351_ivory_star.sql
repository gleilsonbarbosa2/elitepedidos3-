/*
  # Remove Table Sales Menu

  1. Changes
    - Remove the can_view_table_sales permission from all operators
    - Update the admin user to have all other permissions except table_sales
