/*
  # Track All Payment Types in Cash Register

  1. New Features
    - Track all payment types (cash, card, PIX) in cash register
    - Update cash register summary to include all payment methods
    - Require open cash register for all sales

  2. Changes
    - Update link_sale_to_cash_register function to track all payment types
    - Update process_pdv_sale function to require open cash register
    - Fix get_pdv_cash_summary function to properly calculate totals
*/
