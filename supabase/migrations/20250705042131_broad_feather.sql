/*
  ...
  1. Changes
    - Update get_pdv_cash_summary function to properly calculate all sales totals
    - Ensure delivery sales are correctly included in the summary
    - Fix calculation of expected balance to include all cash transactions
    - Add total_all_sales field to the summary result
