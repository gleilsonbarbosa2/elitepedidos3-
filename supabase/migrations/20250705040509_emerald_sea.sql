/*
  # Fix Cash Register Permissions and Total Calculation

  1. Changes
    - Update get_pdv_cash_summary function to properly calculate totals
    - Ensure all sales (PDV and delivery) are included in the total
    - Fix the expected balance calculation to include all payment methods
