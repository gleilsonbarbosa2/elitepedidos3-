/*
  # Add Daily Sales Function

  1. New Functions
    - `get_daily_sales_summary` - Returns a summary of sales for the current day
  
  2. Updates
    - Updates all operators to have necessary permissions
    - Ensures admin user has all permissions
*/
